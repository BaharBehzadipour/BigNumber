...
int main() {
    ...
    cout<<"myBigNumber2 + myBigNumber1 = "<< ( myBigNumber2 + myBigNumber1 ) <<endl; //call operator + for BigNumber
    cout<<"myBigNumber2 - myBigNumber1 = "<< ( myBigNumber2 - myBigNumber1 ) <<endl; //call operator - for BigNumber
    ...
    cout<<"myBigNumber2 >= myBigNumber1 : "<< (myBigNumber2 >= myBigNumber1)<<endl; //call operator >= for BigNumber
    cout<<"myBigNumber2 > myBigNumber1 : "<<( myBigNumber2 > myBigNumber1)<<endl; //call operator > for BigNumber
    cout<<"unsignedMax(myBigNumber1,myBigNumber2) : "<<BigNumber::unsignedMax(myBigNumber1,myBigNumber2)<<endl; //call unsignedMax function for BigNumber
    cout<<"unsignedMin(myBigNumber1,myBigNumber2) : "<<BigNumber::unsignedMin(myBigNumber1,myBigNumber2)<<endl; //call unsignedMin function for BigNumber
    cout<<"unsignedSubtract(myBigNumber1,myBigNumber2) : "<<BigNumber::unsignedSubtract(myBigNumber1,myBigNumber2)<<endl; //call unsignedSubtract function for BigNumber
    int a = myBigNumber2[1];
    cout<<"myBigNumber2[1] = "<< a <<endl; //call operator [] for BigNumber
    cout<<"myBigNumber2.absoluteValue() : "<< myBigNumber2.absoluteValue() <<endl; //call absoluteValue function for BigNumber
    ...
    cout<<"multByOneDigit(myBigNumber1 , 2 ) : "<<MyBigNumber::multByOneDigit(myBigNumber1 , 2 )<<endl; //call multByOneDigit function for MyBigNumber
